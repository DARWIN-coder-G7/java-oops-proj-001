...
public class model {
	...
	public void rename() throws IOException {
		...
		file.createNewFile();
		File newname = new File("c:\\users\\ELCOT\\filemanager\\erm.txt");
	...
	// name alone
	public void listall() {
		 File file = new File ("c:\\users\\ELCOT");
	...
	public void checkExten() {
		File file = new File("c:\\users\\ELCOT\\filemanager");
